...
function generateQuestion() {
  ...
  questionElement.textContent = `What is ${num1} * ${num2}?`; // Corrected to multiplication

  // Store the correct answer using a data attribute or another method
  questionElement.setAttribute('data-answer', num1 * num2); // Corrected to multiplication
}
